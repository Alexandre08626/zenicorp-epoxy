...
export const metadata: Metadata = {
  title: 'Soumission gratuite - Époxy | ZeniCorp',
      ...
      <form className="card p-8">
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <input className="input-field" placeholder="Numéro et rue" />
        ...
        <div className="mb-8">
          ...
          <textarea className="input-field min-h-32" placeholder="Décrivez votre projet : état du plancher, fissures, taches d'huile, couleur souhaitée, paillettes..." />
        </div>
        ...
        <div className="mb-8">
          ...
          <label className="border-2 border-dashed border-zenicorp-border p-8 flex flex-col items-center justify-center cursor-pointer hover:border-zenicorp-gold transition-colors">
            ...
            <span className="text-xs text-zenicorp-mediumGray mt-1">JPG, PNG - max 10 photos ou 1 vidéo</span>
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <input className="input-field" placeholder="Prénom et nom" />
        ...
        <div className="mb-8 bg-zenicorp-lightGray border border-zenicorp-border p-6">
          ...
          <div className="grid grid-cols-2 gap-3 text-sm">
            {[
              ['Type de projet', 'Garage résidentiel'],
